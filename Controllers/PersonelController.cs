...
namespace PersonelSistemi.Controllers
{
    public class PersonelController : Controller
    {
        ...
        public IActionResult Index(string? adi, string? soyadi, string? siralamaAlani, string? siralamaCiheti)
        {
            ...
            var dinamikListe = personeller.Select(p =>
            {
        ...
        public IActionResult Ekle(Personel personel)
        {
            ...
            ModelState.Remove("personel_id");
            if (!ModelState.IsValid) return View(personel);
            personel.personel_id = "0";
            personel.tc = "00000000000";
        ...
        {
            var p = _context.Personeller.Find(id);
            if (p != null) { _context.Personeller.Remove(p); _context.SaveChanges(); }
            return RedirectToAction("Index");
        }
